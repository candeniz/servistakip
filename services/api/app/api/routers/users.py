...
async def import_users(current: User = Depends(_admin)) -> MessageResponse:
    # Excel toplu yükleme iskeleti — dosya ayrıştırma prod'da eklenir.
    return MessageResponse(detail="Toplu yükleme kuyruğa alındı.")
